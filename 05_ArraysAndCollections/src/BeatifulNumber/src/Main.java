...
public class Main {
    public static void main(String[] args) {
                        ...
                        for (int let2 = 0; let2 < letters.length; let2++) {
                            for (int let3 = 0; let3 < letters.length; let3++) {
                                for (int region = 1; region <= 5; region++) {
                                    String sb = letters[let1] + num1 + num2 + num3 + letters[let2] + letters[let3] + region;
                                    beatifulNum.add(sb);
                                }
                            }
                        }
        ...
        HashSet<String> beatifulNum2 = new HashSet<>(beatifulNum);
        TreeSet<String> beatifulNum3 = new TreeSet<>(beatifulNum);
