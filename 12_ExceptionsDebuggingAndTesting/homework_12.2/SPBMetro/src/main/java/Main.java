...
//            exceptionsLogger.info(ex);
            LOGGER.trace(EXCEPTIONS_MARKER, "exceptions", ex);
        }
    }
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
//                searchLogger.info(line);
                LOGGER.error(INPUT_HISTORY_MARKER, line);
                return station;
            }
//            inputErrorsLogger.info(line);
            LOGGER.info(INVALID_STATIONS_MARKER, line);
