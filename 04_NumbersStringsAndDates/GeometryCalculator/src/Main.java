public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(GeometryCalculator.getCircleSquare(Math.abs(3d)));
        System.out.println(GeometryCalculator.getCircleSquare(Math.abs(-5)));
        System.out.println(GeometryCalculator.getCircleSquare(Math.abs(6.56)));

        System.out.println("\nSphere Volume");
        System.out.println(GeometryCalculator.getSphereVolume(Math.abs(1d)));
        System.out.println(GeometryCalculator.getSphereVolume(Math.abs(57.6)));
        System.out.println(GeometryCalculator.getSphereVolume(Math.abs(0)));
